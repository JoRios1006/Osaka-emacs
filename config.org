...
#+LANGUAGE: en
#+OPTIONS: num:nil
The dumbest Emacs distribution

[[./osaka.png]]
* Introduction
Osaka-emacs is a very simple and basic configuration file for Emacs. From here you can edit, remove, or add many aspects of Emacs you want. I encourage you to do so, because Emacs works best when it's customized to your own liking!
* Why would I use this?
#+BEGIN_QUOTE
OH MAY GAH!
#+END_QUOTE
Currently, the appeal of +Witchmacs+ Osaka-emacs is seeing a cute Osaka picture everytime you start up Emacs. Also, it is a very basic config which means you can easily add, edit or remove things as you like. You can use this as a building block when making your OWN Emacs config!
Also I'll try to dumb it down so even Osaka could use this!

#+BEGIN_QUOTE
Do you ever wonder why we're here?
#+END_QUOTE
As opposed to many other Emacs distributions, +Witchmacs+ Osaka-emacs has ZERO customization layers which means you can just jump in, look at the config file and start editing away! After all, Emacs works best when it's customized to your own liking!
* Quick install
#+BEGIN_SRC 
git clone https://github.com/JoRios1006/Osaka-emacs ~/.emacs.d
#+END_SRC
...
Also, to get autocompletion on C and C++ files, you'll need to install the corresponding company backend servers first (you'll be automatically prompted to do so the first time you open a relevant file)
* Dependencies
